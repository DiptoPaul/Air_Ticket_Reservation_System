...
<html>
    ...
    <body class = "blue-grey darken-3 indigo-text text-lighten-3"  style = "padding : 7% 15%">
        ...
        <h4>Create New Flight Schedule</h4>
        <form class="col s12" action = "" method = "POST">
                ...
                <div class="row">
                    <div class="input-field col s4">
                        ...
                        <input id="departure" type="text" name="departure" class="timepicker">
                ...
                <div class="row">
                    <div class="input-field col s4">
                        <i class="material-icons prefix">alarm</i>
                        <input id="arrival" type="text" name="arrival" class="timepicker">
                ...
                <div class="row">
                    <div class="input-field col s4">
                        ...
                        <input id="seat" type="text" name="seat" class="validate">
                        <label for="seat">Seat</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col s4">
                        <button class="btn waves-effect waves-light blue" type="submit" name="Create">Create
